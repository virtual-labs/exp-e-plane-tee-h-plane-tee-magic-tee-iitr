...
(function (window, undefined) {
   ...
   if(text == "Beam Voltage" )
   {
    Swal.fire({
     ...
     width:'480px',
      ...
      text:'Toggle the switch button and note down the value for voltage at port 3.',     
      icon:'warning',
      });
   }
  else if(v6==0){
    Swal.fire({
      ...
      customClass: {
       ...
       title:'Missing!',
       text:'Please enter the value for voltage.',     
       icon:'warning',
       });
  return
  }
  ...
  Swal.fire({
   ...
   width:'480px',
    ...
    text:'Basic Properties of Magic Tee when input is at Port 4 has been studied successfully.',     
    icon:'success',
    }).then((result) => {
      if (result.isConfirmed) {
        Swal.fire({
         ...
         width:'480px',
          ...
          html:' Click on <b style="color:blue">Next</b> button to study basic properties of Magic tee when input is at Port 3.',     
          icon:'info',
      });}
