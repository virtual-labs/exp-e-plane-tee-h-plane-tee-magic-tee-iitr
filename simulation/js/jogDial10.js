...
(function (window, undefined) {
   ...
   if(text == "Beam Voltage" )
   {
    Swal.fire({
     ...
     width:'480px',
      ...
      text:'Toggle the switch button and note down the value for voltage at port 4.',     
      icon:'warning',
      });
   }
  else if(v6==0){
  ...
  Swal.fire({
   ...
   width:'480px',
    ...
    text:'Basic Properties of Magic Tee when input is at Port 3 has been studied successfully.',     
    icon:'success',
    }).then((result) => {
      if (result.isConfirmed) {
        Swal.fire({
         ...
         width:'480px',
          ...
          html:'Click on <b style="color:blue">Print</b> button to get all the readings.',     
          icon:'info',
      });}
