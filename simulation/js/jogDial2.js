 ...
 if(text == "Beam Voltage" )
 {
  Swal.fire({
   ...
   width:'480px',
    ...
    text:'Toggle the switch button and note down the value for output voltage at port 1.',     
    icon:'warning',
    });
 }
else if(v2==0){
  Swal.fire({
   ...
   width:'500px',
    ...
    title:'Missing!',
    text:'Please enter the value for output voltage at port 1.',     
    icon:'warning',
    });
...
Swal.fire({
 ...
 width:'480px',
  ...
  html:'Click on <b style="color:blue">Next</b> button for voltage at port 2.',     
  icon:'info',
  });
